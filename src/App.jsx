...
export default function App() {
    ...
    const ensureAudio = async () => {
        ...
        initPromiseRef.current = (async () => {
            ...
            softSat.curve = makeSoftSatCurve(SOUND_MODE === "RADIO" ? 0.40 : 0.55);
            ...
            hissGain.gain.value = SOUND_MODE === "RADIO" ? 0.012 : 0.010;
    ...
    useEffect(() => {
        const tick = () => {
            if (readyRef.current && duration) {
                ...
                // damping at ends
                if (
                    playheadRef.current <= 0.0005 ||
                    playheadRef.current >= duration - 0.0005
                ) {
        ...
        <div className="min-h-[100dvh] bg-[#f4f1ec] flex items-center justify-center p-6 text-[#2b2621]">
            <div className="w-full max-w-[420px] rounded-2xl border border-[#d8d2c8] bg-[#faf8f4] shadow-sm relative overflow-hidden">
                ...
                <div className="px-6 pt-6 pb-4 relative">
                    <p className="text-xs tracking-widest uppercase text-[#7a7268]" style={{ fontFamily: handwrittenFont }}>
                        Audio Memory Hun
                    </p>
                ...
                <div className="px-6 relative">
                    ...
                    <div className="flex justify-between text-[11px] text-[#7a7268] mt-2" style={{ fontFamily: handwrittenFont }}>
                ...
                <div className="mt-6 overflow-hidden relative">
                    <div
                        className="flex gap-4 px-6 transition-transform duration-75"
                        style={{ transform: `translateX(-${photoOffset}px)`, opacity: photosOpacity }}
                    >
                        {images.map((src, i) => (
                ...
                <div className="flex justify-center py-10 relative">
                    <div
                        ...
                        style={{ transform: `rotate(${angle}deg)`, background: "#f8f5ef", border: "1px solid #d8d2c8" }}
                    >
